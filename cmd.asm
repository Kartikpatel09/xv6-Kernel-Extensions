   ...
   a:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  15:	7e 26                	jle    3d <main+0x3d>
    ...
    int id = fork();
  17:	e8 8f 02 00 00       	call   2ab <fork>
    if (id == 0)
  1c:	85 c0                	test   %eax,%eax
  1e:	75 13                	jne    33 <main+0x33>
    {
