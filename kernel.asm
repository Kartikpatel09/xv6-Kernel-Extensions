...
801002e0:	75 36                	jne    80100318 <consoleread+0x98>
      if(myproc()->killed){
801002e2:	e8 19 37 00 00       	call   80103a00 <myproc>
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 ab 81 10 80 	movl   $0x801081ab,(%esp)
...
80100abc:	e8 3f 2f 00 00       	call   80103a00 <myproc>
...
80102088:	68 6a 7f 10 80       	push   $0x80107f6a
...
80103022:	e8 79 2d 00 00       	call   80105da0 <idtinit>
...
8010303a:	e8 b1 0e 00 00       	call   80103ef0 <scheduler>
8010303f:	90                   	nop
...
801030a9:	e8 22 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 6d 2c 00 00       	call   80105d20 <tvinit>
  binit();         // buffer cache
...
80103621:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->readopen == 0 || myproc()->killed){
80103628:	e8 d3 03 00 00       	call   80103a00 <myproc>
...
801036fe:	66 90                	xchg   %ax,%ax
    if(myproc()->killed){
80103700:	e8 fb 02 00 00       	call   80103a00 <myproc>
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint *)sp = (uint)trapret;
80103827:	c7 40 14 12 5d 10 80 	movl   $0x80105d12,0x14(%eax)
  p->context = (struct context *)sp;
...
801038d6:	68 00 7d 10 80       	push   $0x80107d00
...
801038f9:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pde = &pgdir[PDX(va)];
801038fc:	8b 55 08             	mov    0x8(%ebp),%edx
801038ff:	89 fe                	mov    %edi,%esi
80103901:	c1 ee 16             	shr    $0x16,%esi
80103904:	8d 34 b2             	lea    (%edx,%esi,4),%esi
  if (*pde & PTE_P)
80103907:	8b 1e                	mov    (%esi),%ebx
80103909:	f6 c3 01             	test   $0x1,%bl
8010390c:	74 22                	je     80103930 <walkpgdir+0x40>
    pgtab = (pte_t *)P2V(PTE_ADDR(*pde));
8010390e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80103914:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  return &pgtab[PTX(va)];
8010391a:	89 f8                	mov    %edi,%eax
}
8010391c:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
8010391f:	c1 e8 0a             	shr    $0xa,%eax
80103922:	25 fc 0f 00 00       	and    $0xffc,%eax
80103927:	01 d8                	add    %ebx,%eax
}
80103929:	5b                   	pop    %ebx
8010392a:	5e                   	pop    %esi
8010392b:	5f                   	pop    %edi
...
80103935:	74 31                	je     80103968 <walkpgdir+0x78>
80103937:	e8 44 ed ff ff       	call   80102680 <kalloc>
8010393c:	89 c3                	mov    %eax,%ebx
8010393e:	85 c0                	test   %eax,%eax
80103940:	74 26                	je     80103968 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
80103942:	83 ec 04             	sub    $0x4,%esp
80103945:	68 00 10 00 00       	push   $0x1000
8010394a:	6a 00                	push   $0x0
8010394c:	50                   	push   %eax
8010394d:	e8 ce 0f 00 00       	call   80104920 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80103952:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80103958:	83 c4 10             	add    $0x10,%esp
8010395b:	83 c8 07             	or     $0x7,%eax
8010395e:	89 06                	mov    %eax,(%esi)
80103960:	eb b8                	jmp    8010391a <walkpgdir+0x2a>
80103962:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
}
80103968:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return 0;
8010396b:	31 c0                	xor    %eax,%eax
}
8010396d:	5b                   	pop    %ebx
8010396e:	5e                   	pop    %esi
8010396f:	5f                   	pop    %edi
80103970:	5d                   	pop    %ebp
80103971:	c3                   	ret    
80103972:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80103a04:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103a07:	e8 04 0d 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103a0c:	e8 6f ff ff ff       	call   80103980 <mycpu>
  p = c->proc;
80103a11:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a17:	e8 44 0d 00 00       	call   80104760 <popcli>
}
80103a1c:	89 d8                	mov    %ebx,%eax
80103a1e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103a21:	c9                   	leave  
80103a22:	c3                   	ret    
...
80103a34:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103a37:	e8 74 fd ff ff       	call   801037b0 <allocproc>
80103a3c:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103a3e:	a3 54 4c 11 80       	mov    %eax,0x80114c54
  if ((p->pgdir = setupkvm()) == 0)
80103a43:	e8 18 3a 00 00       	call   80107460 <setupkvm>
80103a48:	89 43 04             	mov    %eax,0x4(%ebx)
80103a4b:	85 c0                	test   %eax,%eax
80103a4d:	0f 84 bd 00 00 00    	je     80103b10 <userinit+0xe0>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80103a53:	83 ec 04             	sub    $0x4,%esp
80103a56:	68 2c 00 00 00       	push   $0x2c
80103a5b:	68 60 b4 10 80       	push   $0x8010b460
80103a60:	50                   	push   %eax
80103a61:	e8 aa 36 00 00       	call   80107110 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
80103a66:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
80103a69:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103a6f:	6a 4c                	push   $0x4c
80103a71:	6a 00                	push   $0x0
80103a73:	ff 73 18             	push   0x18(%ebx)
80103a76:	e8 a5 0e 00 00       	call   80104920 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a7b:	8b 43 18             	mov    0x18(%ebx),%eax
80103a7e:	ba 1b 00 00 00       	mov    $0x1b,%edx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a83:	83 c4 0c             	add    $0xc,%esp
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a86:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a8b:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a8f:	8b 43 18             	mov    0x18(%ebx),%eax
80103a92:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103a96:	8b 43 18             	mov    0x18(%ebx),%eax
80103a99:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a9d:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103aa1:	8b 43 18             	mov    0x18(%ebx),%eax
80103aa4:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103aa8:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103aac:	8b 43 18             	mov    0x18(%ebx),%eax
80103aaf:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103ab6:	8b 43 18             	mov    0x18(%ebx),%eax
80103ab9:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0; // beginning of initcode.S
80103ac0:	8b 43 18             	mov    0x18(%ebx),%eax
80103ac3:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103aca:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103acd:	6a 10                	push   $0x10
80103acf:	68 30 7d 10 80       	push   $0x80107d30
80103ad4:	50                   	push   %eax
80103ad5:	e8 06 10 00 00       	call   80104ae0 <safestrcpy>
  p->cwd = namei("/");
80103ada:	c7 04 24 39 7d 10 80 	movl   $0x80107d39,(%esp)
80103ae1:	e8 ba e5 ff ff       	call   801020a0 <namei>
80103ae6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103ae9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103af0:	e8 6b 0d 00 00       	call   80104860 <acquire>
  p->state = RUNNABLE;
80103af5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103afc:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b03:	e8 f8 0c 00 00       	call   80104800 <release>
}
...
80103b13:	68 17 7d 10 80       	push   $0x80107d17
80103b18:	e8 63 c8 ff ff       	call   80100380 <panic>
...
80103b25:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103b28:	e8 e3 0b 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103b2d:	e8 4e fe ff ff       	call   80103980 <mycpu>
  p = c->proc;
80103b32:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b38:	e8 23 0c 00 00       	call   80104760 <popcli>
  sz = curproc->sz;
...
80103b4b:	e8 b0 34 00 00       	call   80107000 <switchuvm>
  return 0;
...
80103b6a:	e8 11 37 00 00       	call   80107280 <allocuvm>
...
80103b8a:	e8 21 38 00 00       	call   801073b0 <deallocuvm>
...
80103ba6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103ba9:	e8 62 0b 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103bae:	e8 cd fd ff ff       	call   80103980 <mycpu>
  p = c->proc;
80103bb3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bb9:	e8 a2 0b 00 00       	call   80104760 <popcli>
  if (n % PGSIZE != 0)
80103bbe:	31 c0                	xor    %eax,%eax
80103bc0:	f7 45 08 ff 0f 00 00 	testl  $0xfff,0x8(%ebp)
80103bc7:	75 37                	jne    80103c00 <mmap+0x60>
  uint add = myproc()->sz;
80103bc9:	8b 1b                	mov    (%ebx),%ebx
  pushcli();
80103bcb:	e8 40 0b 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103bd0:	e8 ab fd ff ff       	call   80103980 <mycpu>
  p = c->proc;
80103bd5:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bdb:	e8 80 0b 00 00       	call   80104760 <popcli>
  myproc()->sz = myproc()->sz + n;
80103be0:	8b 3e                	mov    (%esi),%edi
  pushcli();
80103be2:	e8 29 0b 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103be7:	e8 94 fd ff ff       	call   80103980 <mycpu>
  p = c->proc;
80103bec:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bf2:	e8 69 0b 00 00       	call   80104760 <popcli>
  myproc()->sz = myproc()->sz + n;
80103bf7:	8b 45 08             	mov    0x8(%ebp),%eax
80103bfa:	01 f8                	add    %edi,%eax
80103bfc:	89 06                	mov    %eax,(%esi)
  return (int)add;
...
80103c10 <numberofprocesses>:
{
80103c10:	55                   	push   %ebp
80103c11:	89 e5                	mov    %esp,%ebp
80103c13:	53                   	push   %ebx
  int count = 0;            // Initialize a counter to keep track of the number of RUNNABLE processes.
80103c14:	31 db                	xor    %ebx,%ebx
{
80103c16:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);    // Acquire the process table lock 
80103c19:	68 20 2d 11 80       	push   $0x80112d20
80103c1e:	e8 3d 0c 00 00       	call   80104860 <acquire>
80103c23:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c26:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103c2b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103c2f:	90                   	nop
      count++;  
80103c30:	31 d2                	xor    %edx,%edx
80103c32:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103c36:	0f 94 c2             	sete   %dl
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c39:	83 c0 7c             	add    $0x7c,%eax
      count++;  
80103c3c:	01 d3                	add    %edx,%ebx
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c3e:	3d 54 4c 11 80       	cmp    $0x80114c54,%eax
80103c43:	75 eb                	jne    80103c30 <numberofprocesses+0x20>
  release(&ptable.lock);    // Release the process table lock after iteration is complete.
80103c45:	83 ec 0c             	sub    $0xc,%esp
80103c48:	68 20 2d 11 80       	push   $0x80112d20
80103c4d:	e8 ae 0b 00 00       	call   80104800 <release>
}
80103c52:	89 d8                	mov    %ebx,%eax
80103c54:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103c57:	c9                   	leave  
80103c58:	c3                   	ret    
80103c59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80103c60 <get_pgtb_size>:
{
...
80103c64:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103c67:	e8 a4 0a 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103c6c:	e8 0f fd ff ff       	call   80103980 <mycpu>
  p = c->proc;
80103c71:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c77:	e8 e4 0a 00 00       	call   80104760 <popcli>
  int count = 0;              
80103c7c:	31 c9                	xor    %ecx,%ecx
80103c7e:	8b 43 04             	mov    0x4(%ebx),%eax
80103c81:	8d 98 00 10 00 00    	lea    0x1000(%eax),%ebx
80103c87:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103c8e:	66 90                	xchg   %ax,%ax
    if (p->pgdir[i] & PTE_P)
80103c90:	8b 10                	mov    (%eax),%edx
80103c92:	83 e2 01             	and    $0x1,%edx
      count++;  // Increment the counter for each present page table page.
80103c95:	83 fa 01             	cmp    $0x1,%edx
80103c98:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for (uint i = 0; i < NPDENTRIES; i++)
80103c9b:	83 c0 04             	add    $0x4,%eax
80103c9e:	39 d8                	cmp    %ebx,%eax
80103ca0:	75 ee                	jne    80103c90 <get_pgtb_size+0x30>
}
...
80103cb4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103cb7:	e8 54 0a 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103cbc:	e8 bf fc ff ff       	call   80103980 <mycpu>
  p = c->proc;
80103cc1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cc7:	e8 94 0a 00 00       	call   80104760 <popcli>
  for (uint i = 0; i < NPDENTRIES; i++)
80103ccc:	31 c0                	xor    %eax,%eax
    if (p->pgdir[i] & PTE_P)
80103cce:	8b 4b 04             	mov    0x4(%ebx),%ecx
  int count = 0;
80103cd1:	31 db                	xor    %ebx,%ebx
80103cd3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103cd7:	90                   	nop
      if (i < k)
80103cd8:	3d ff 01 00 00       	cmp    $0x1ff,%eax
80103cdd:	0f 96 c2             	setbe  %dl
80103ce0:	22 14 81             	and    (%ecx,%eax,4),%dl
  for (uint i = 0; i < NPDENTRIES; i++)
80103ce3:	83 c0 01             	add    $0x1,%eax
      if (i < k)
80103ce6:	84 d2                	test   %dl,%dl
80103ce8:	75 16                	jne    80103d00 <get_usr_pgtb_size+0x50>
  for (uint i = 0; i < NPDENTRIES; i++)
80103cea:	3d 00 04 00 00       	cmp    $0x400,%eax
80103cef:	75 e7                	jne    80103cd8 <get_usr_pgtb_size+0x28>
}
...
80103cff:	90                   	nop
        count++;
80103d00:	83 c3 01             	add    $0x1,%ebx
  for (uint i = 0; i < NPDENTRIES; i++)
80103d03:	eb d3                	jmp    80103cd8 <get_usr_pgtb_size+0x28>
80103d05:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103d0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80103d10 <get_kernel_pgtb_size>:
{
...
80103d14:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103d17:	e8 f4 09 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103d1c:	e8 5f fc ff ff       	call   80103980 <mycpu>
  p = c->proc;
80103d21:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d27:	e8 34 0a 00 00       	call   80104760 <popcli>
  for (uint i = 0; i < NPDENTRIES; i++)
80103d2c:	31 c0                	xor    %eax,%eax
  int count = 0;
80103d2e:	31 c9                	xor    %ecx,%ecx
  for (uint i = 0; i < NPDENTRIES; i++)
80103d30:	83 c0 01             	add    $0x1,%eax
80103d33:	3d 00 04 00 00       	cmp    $0x400,%eax
80103d38:	74 21                	je     80103d5b <get_kernel_pgtb_size+0x4b>
    if (p->pgdir[i] & PTE_P)
80103d3a:	8b 53 04             	mov    0x4(%ebx),%edx
      if (i >= k)
80103d3d:	f6 04 82 01          	testb  $0x1,(%edx,%eax,4)
80103d41:	74 ed                	je     80103d30 <get_kernel_pgtb_size+0x20>
80103d43:	3d ff 01 00 00       	cmp    $0x1ff,%eax
80103d48:	0f 97 c2             	seta   %dl
        count++;
80103d4b:	80 fa 01             	cmp    $0x1,%dl
80103d4e:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for (uint i = 0; i < NPDENTRIES; i++)
80103d51:	83 c0 01             	add    $0x1,%eax
80103d54:	3d 00 04 00 00       	cmp    $0x400,%eax
80103d59:	75 df                	jne    80103d3a <get_kernel_pgtb_size+0x2a>
}
80103d5b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103d5e:	89 c8                	mov    %ecx,%eax
80103d60:	c9                   	leave  
80103d61:	c3                   	ret    
...
80103d75:	8b 75 08             	mov    0x8(%ebp),%esi
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d78:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
80103d7d:	83 ec 0c             	sub    $0xc,%esp
80103d80:	68 20 2d 11 80       	push   $0x80112d20
80103d85:	e8 d6 0a 00 00       	call   80104860 <acquire>
80103d8a:	83 c4 10             	add    $0x10,%esp
80103d8d:	eb 0c                	jmp    80103d9b <getProcess+0x2b>
80103d8f:	90                   	nop
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d90:	83 c3 7c             	add    $0x7c,%ebx
80103d93:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
80103d99:	74 05                	je     80103da0 <getProcess+0x30>
    if (p->pid == pid)
80103d9b:	39 73 10             	cmp    %esi,0x10(%ebx)
80103d9e:	75 f0                	jne    80103d90 <getProcess+0x20>
  release(&ptable.lock);
80103da0:	83 ec 0c             	sub    $0xc,%esp
80103da3:	68 20 2d 11 80       	push   $0x80112d20
80103da8:	e8 53 0a 00 00       	call   80104800 <release>
}
80103dad:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103db0:	89 d8                	mov    %ebx,%eax
80103db2:	5b                   	pop    %ebx
80103db3:	5e                   	pop    %esi
80103db4:	5d                   	pop    %ebp
80103db5:	c3                   	ret    
...
80103dc6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103dc9:	e8 42 09 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103dce:	e8 ad fb ff ff       	call   80103980 <mycpu>
  p = c->proc;
80103dd3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dd9:	e8 82 09 00 00       	call   80104760 <popcli>
  if ((np = allocproc()) == 0)
80103dde:	e8 cd f9 ff ff       	call   801037b0 <allocproc>
...
80103df5:	ff 73 04             	push   0x4(%ebx)
80103df8:	e8 53 37 00 00       	call   80107550 <copyuvm>
80103dfd:	83 c4 10             	add    $0x10,%esp
80103e00:	89 47 04             	mov    %eax,0x4(%edi)
...
80103e10:	89 01                	mov    %eax,(%ecx)
  *np->tf = *curproc->tf;
80103e12:	8b 79 18             	mov    0x18(%ecx),%edi
  np->parent = curproc;
80103e15:	89 c8                	mov    %ecx,%eax
80103e17:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
80103e1a:	b9 13 00 00 00       	mov    $0x13,%ecx
80103e1f:	8b 73 18             	mov    0x18(%ebx),%esi
...
80103e3c:	e8 5f d0 ff ff       	call   80100ea0 <filedup>
...
80103e56:	ff 73 68             	push   0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103e59:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103e5c:	e8 ef d8 ff ff       	call   80101750 <idup>
...
80103e71:	e8 6a 0c 00 00       	call   80104ae0 <safestrcpy>
  pid = np->pid;
80103e76:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103e79:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e80:	e8 db 09 00 00       	call   80104860 <acquire>
  np->state = RUNNABLE;
80103e85:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103e8c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e93:	e8 68 09 00 00       	call   80104800 <release>
  return pid;
...
80103eb2:	ff 73 08             	push   0x8(%ebx)
80103eb5:	e8 06 e6 ff ff       	call   801024c0 <kfree>
    np->kstack = 0;
...
80103ee0 <mysystem_call>:
{
80103ee0:	55                   	push   %ebp
80103ee1:	89 e5                	mov    %esp,%ebp
    cprintf("Yes I am new sysytem call you selected less than 45");
80103ee3:	c7 45 08 0c 7e 10 80 	movl   $0x80107e0c,0x8(%ebp)
}
80103eea:	5d                   	pop    %ebp
    cprintf("Yes I am new sysytem call you selected less than 45");
80103eeb:	e9 b0 c7 ff ff       	jmp    801006a0 <cprintf>
...
80103ef6:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103ef9:	e8 82 fa ff ff       	call   80103980 <mycpu>
  c->proc = 0;
...
80103f14:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
80103f19:	68 20 2d 11 80       	push   $0x80112d20
...
80103f40:	e8 bb 30 00 00       	call   80107000 <switchuvm>
...
80103f52:	e8 e4 0b 00 00       	call   80104b3b <swtch>
      switchkvm();
80103f57:	e8 94 30 00 00       	call   80106ff0 <switchkvm>
      c->proc = 0;
...
80103f6c:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
...
80103f95:	e8 76 07 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103f9a:	e8 e1 f9 ff ff       	call   80103980 <mycpu>
  p = c->proc;
...
80103fbc:	74 4f                	je     8010400d <sched+0x7d>
  if (mycpu()->ncli != 1)
80103fbe:	e8 bd f9 ff ff       	call   80103980 <mycpu>
...
80103fd7:	75 41                	jne    8010401a <sched+0x8a>
  intena = mycpu()->intena;
80103fd9:	e8 a2 f9 ff ff       	call   80103980 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103fde:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103fe1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103fe7:	e8 94 f9 ff ff       	call   80103980 <mycpu>
...
80103ff3:	e8 43 0b 00 00       	call   80104b3b <swtch>
  mycpu()->intena = intena;
80103ff8:	e8 83 f9 ff ff       	call   80103980 <mycpu>
}
...
80104056:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80104059:	e8 a2 f9 ff ff       	call   80103a00 <myproc>
  if (curproc == initproc)
8010405e:	39 05 54 4c 11 80    	cmp    %eax,0x80114c54
...
801040f4:	75 e4                	jne    801040da <exit+0x8a>
      p->parent = initproc;
801040f6:	8b 0d 54 4c 11 80    	mov    0x80114c54,%ecx
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040fc:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80104101:	eb 10                	jmp    80104113 <exit+0xc3>
80104103:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104107:	90                   	nop
80104108:	83 c2 7c             	add    $0x7c,%edx
8010410b:	81 fa 54 4c 11 80    	cmp    $0x80114c54,%edx
...
8010415d:	68 88 7d 10 80       	push   $0x80107d88
80104162:	e8 19 c2 ff ff       	call   80100380 <panic>
    panic("init exiting");
80104167:	83 ec 0c             	sub    $0xc,%esp
8010416a:	68 7b 7d 10 80       	push   $0x80107d7b
...
801041d1:	b8 01 00 00 00       	mov    $0x1,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041d6:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
...
801041f1:	e8 1a 05 00 00       	call   80104710 <pushcli>
  c = mycpu();
801041f6:	e8 85 f7 ff ff       	call   80103980 <mycpu>
  p = c->proc;
...
80104249:	e8 92 31 00 00       	call   801073e0 <freevm>
        p->pid = 0;
...
801042a0:	68 94 7d 10 80       	push   $0x80107d94
...
801042dd:	e8 ae fc ff ff       	call   80103f90 <sched>
  release(&ptable.lock);
801042e2:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
...
8010432e:	74 76                	je     801043a6 <sleep+0xa6>
  if (lk != &ptable.lock)
80104330:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
...
801043a9:	68 9a 7d 10 80       	push   $0x80107d9a
801043ae:	e8 cd bf ff ff       	call   80100380 <panic>
    panic("sleep");
801043b3:	83 ec 0c             	sub    $0xc,%esp
801043b6:	68 94 7d 10 80       	push   $0x80107d94
...
801043ff:	3d 54 4c 11 80       	cmp    $0x80114c54,%eax
80104404:	75 e4                	jne    801043ea <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104406:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
...
80104483:	68 20 2d 11 80       	push   $0x80112d20
...
801044a9:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
...
801044dc:	74 ea                	je     801044c8 <procdump+0x28>
      state = "???";
801044de:	ba ab 7d 10 80       	mov    $0x80107dab,%edx
    if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
801044e3:	83 f8 05             	cmp    $0x5,%eax
801044e6:	77 11                	ja     801044f9 <procdump+0x59>
801044e8:	8b 14 85 40 7e 10 80 	mov    -0x7fef81c0(,%eax,4),%edx
      state = "???";
801044ef:	b8 ab 7d 10 80       	mov    $0x80107dab,%eax
...
801044fe:	68 af 7d 10 80       	push   $0x80107daf
...
8010453d:	68 01 78 10 80       	push   $0x80107801
...
8010456a:	68 58 7e 10 80       	push   $0x80107e58
...
801045d3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801045d9:	e8 22 f4 ff ff       	call   80103a00 <myproc>
...
8010467b:	e8 80 f3 ff ff       	call   80103a00 <myproc>
...
8010478c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104790:	e8 eb f1 ff ff       	call   80103980 <mycpu>
...
801047a5:	68 63 7e 10 80       	push   $0x80107e63
801047aa:	e8 d1 bb ff ff       	call   80100380 <panic>
    panic("popcli");
801047af:	83 ec 0c             	sub    $0xc,%esp
801047b2:	68 7a 7e 10 80       	push   $0x80107e7a
...
801047e3:	e8 98 f1 ff ff       	call   80103980 <mycpu>
...
8010489c:	e8 df f0 ff ff       	call   80103980 <mycpu>
...
801048fb:	e8 80 f0 ff ff       	call   80103980 <mycpu>
...
80104910:	68 89 7e 10 80       	push   $0x80107e89
...
80104b57:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104b5a:	e8 a1 ee ff ff       	call   80103a00 <myproc>
...
80104b97:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104b9a:	e8 61 ee ff ff       	call   80103a00 <myproc>
...
80104be5:	e8 16 ee ff ff       	call   80103a00 <myproc>
...
80104bf3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104bf6:	e8 05 ee ff ff       	call   80103a00 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c36:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104c39:	e8 c2 ed ff ff       	call   80103a00 <myproc>
80104c3e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c40:	e8 bb ed ff ff       	call   80103a00 <myproc>
...
80104c4e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c51:	e8 aa ed ff ff       	call   80103a00 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ca4:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ca5:	e8 56 ed ff ff       	call   80103a00 <myproc>
...
80104cb3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104cb6:	e8 45 ed ff ff       	call   80103a00 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ccb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104cce:	e8 2d ed ff ff       	call   80103a00 <myproc>
  if(addr >= curproc->sz)
...
80104d24:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104d27:	e8 d4 ec ff ff       	call   80103a00 <myproc>
...
80104d37:	83 fa 1f             	cmp    $0x1f,%edx
...
80104d68:	68 91 7e 10 80       	push   $0x80107e91
...
80104ec4:	68 60 7f 10 80       	push   $0x80107f60
...
80104edc:	68 5f 7f 10 80       	push   $0x80107f5f
...
80104ef1:	68 53 7f 10 80       	push   $0x80107f53
...
80104f0f:	68 62 7f 10 80       	push   $0x80107f62
80104f14:	e8 67 b4 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104f19:	83 ec 0c             	sub    $0xc,%esp
80104f1c:	68 44 7f 10 80       	push   $0x80107f44
...
80104f50:	e8 ab ea ff ff       	call   80103a00 <myproc>
...
80104f5e:	74 20                	je     80104f80 <sys_dup+0x50>
  struct proc *curproc = myproc();
80104f60:	e8 9b ea ff ff       	call   80103a00 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104fd0:	e8 2b ea ff ff       	call   80103a00 <myproc>
...
80105050:	e8 ab e9 ff ff       	call   80103a00 <myproc>
...
801050d0:	e8 2b e9 ff ff       	call   80103a00 <myproc>
...
801050e1:	74 25                	je     80105108 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
801050e3:	e8 18 e9 ff ff       	call   80103a00 <myproc>
  fileclose(f);
...
80105130:	e8 cb e8 ff ff       	call   80103a00 <myproc>
...
8010531d:	58                   	pop    %eax
8010531e:	5a                   	pop    %edx
8010531f:	68 60 7f 10 80       	push   $0x80107f60
...
80105338:	68 5f 7f 10 80       	push   $0x80107f5f
...
80105527:	74 23                	je     8010554c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105529:	e8 d2 e4 ff ff       	call   80103a00 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056e5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801056e8:	e8 13 e3 ff ff       	call   80103a00 <myproc>
...
801058b7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801058b9:	e8 42 e1 ff ff       	call   80103a00 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801058f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801058fa:	e8 01 e1 ff ff       	call   80103a00 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105916:	75 f0                	jne    80105908 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105918:	e8 e3 e0 ff ff       	call   80103a00 <myproc>
...
80105a8c:	e8 4f f1 ff ff       	call   80104be0 <argint>
80105a91:	83 c4 10             	add    $0x10,%esp
80105a94:	85 c0                	test   %eax,%eax
80105a96:	78 18                	js     80105ab0 <sys_getpasize+0x30>
return getpasize(id);
80105a98:	83 ec 0c             	sub    $0xc,%esp
80105a9b:	ff 75 f4             	push   -0xc(%ebp)
80105a9e:	e8 cd 14 00 00       	call   80106f70 <getpasize>
...
80105ace:	e8 0d f1 ff ff       	call   80104be0 <argint>
80105ad3:	83 c4 10             	add    $0x10,%esp
80105ad6:	85 c0                	test   %eax,%eax
80105ad8:	78 44                	js     80105b1e <sys_spawn+0x5e>
if (argptr(1, (char **)&pid, sizeof(int) * n) < 0)
80105ada:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105add:	83 ec 04             	sub    $0x4,%esp
80105ae0:	c1 e0 02             	shl    $0x2,%eax
80105ae3:	50                   	push   %eax
80105ae4:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105ae7:	50                   	push   %eax
80105ae8:	6a 01                	push   $0x1
80105aea:	e8 41 f1 ff ff       	call   80104c30 <argptr>
80105aef:	83 c4 10             	add    $0x10,%esp
80105af2:	85 c0                	test   %eax,%eax
80105af4:	78 28                	js     80105b1e <sys_spawn+0x5e>
    return -1;

for(int i=0;i<n;i++){
80105af6:	8b 45 f0             	mov    -0x10(%ebp),%eax
int count=0;
80105af9:	31 db                	xor    %ebx,%ebx
for(int i=0;i<n;i++){
80105afb:	85 c0                	test   %eax,%eax
80105afd:	7e 16                	jle    80105b15 <sys_spawn+0x55>
80105aff:	90                   	nop
pid[i]=fork();
80105b00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b03:	8d 34 98             	lea    (%eax,%ebx,4),%esi
count++;
80105b06:	83 c3 01             	add    $0x1,%ebx
pid[i]=fork();
80105b09:	e8 b2 e2 ff ff       	call   80103dc0 <fork>
80105b0e:	89 06                	mov    %eax,(%esi)
for(int i=0;i<n;i++){
80105b10:	39 5d f0             	cmp    %ebx,-0x10(%ebp)
80105b13:	7f eb                	jg     80105b00 <sys_spawn+0x40>
}
return count;

}
80105b15:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105b18:	89 d8                	mov    %ebx,%eax
80105b1a:	5b                   	pop    %ebx
80105b1b:	5e                   	pop    %esi
80105b1c:	5d                   	pop    %ebp
80105b1d:	c3                   	ret    
if(argint(0,&n)<0){return -1;}
80105b1e:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105b23:	eb f0                	jmp    80105b15 <sys_spawn+0x55>
...
80105b3c:	e8 9f f0 ff ff       	call   80104be0 <argint>
80105b41:	83 c4 10             	add    $0x10,%esp
80105b44:	89 c2                	mov    %eax,%edx
80105b46:	31 c0                	xor    %eax,%eax
80105b48:	85 d2                	test   %edx,%edx
80105b4a:	78 0e                	js     80105b5a <sys_mmap+0x2a>
return mmap(n);
80105b4c:	83 ec 0c             	sub    $0xc,%esp
80105b4f:	ff 75 f4             	push   -0xc(%ebp)
80105b52:	e8 49 e0 ff ff       	call   80103ba0 <mmap>
...
80105b63:	83 ec 08             	sub    $0x8,%esp
  exit();
80105b66:	e8 e5 e4 ff ff       	call   80104050 <exit>
...
{
  return wait();
80105b70:	e9 0b e6 ff ff       	jmp    80104180 <wait>
...
80105b8c:	e8 4f f0 ff ff       	call   80104be0 <argint>
...
80105b9e:	e8 7d e8 ff ff       	call   80104420 <kill>
...
80105bc3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105bc6:	e8 35 de ff ff       	call   80103a00 <myproc>
...
80105bf6:	e8 25 df ff ff       	call   80103b20 <growproc>
...
80105c2d:	e8 ae ef ff ff       	call   80104be0 <argint>
...
80105c40:	68 80 4c 11 80       	push   $0x80114c80
80105c45:	e8 16 ec ff ff       	call   80104860 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105c4a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105c4d:	8b 1d 60 4c 11 80    	mov    0x80114c60,%ebx
  while(ticks - ticks0 < n){
...
80105c68:	68 60 4c 11 80       	push   $0x80114c60
80105c6d:	e8 8e e6 ff ff       	call   80104300 <sleep>
  while(ticks - ticks0 < n){
80105c72:	a1 60 4c 11 80       	mov    0x80114c60,%eax
...
80105c7f:	73 2f                	jae    80105cb0 <sys_sleep+0x90>
    if(myproc()->killed){
80105c81:	e8 7a dd ff ff       	call   80103a00 <myproc>
...
80105c90:	68 80 4c 11 80       	push   $0x80114c80
80105c95:	e8 66 eb ff ff       	call   80104800 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105cb3:	68 80 4c 11 80       	push   $0x80114c80
80105cb8:	e8 43 eb ff ff       	call   80104800 <release>
  return 0;
...
80105cd4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105cd7:	68 80 4c 11 80       	push   $0x80114c80
80105cdc:	e8 7f eb ff ff       	call   80104860 <acquire>
  xticks = ticks;
80105ce1:	8b 1d 60 4c 11 80    	mov    0x80114c60,%ebx
  release(&tickslock);
80105ce7:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
80105cee:	e8 0d eb ff ff       	call   80104800 <release>
  return xticks;
}
...
80105d09:	54                   	push   %esp
  call trap
80105d0a:	e8 c1 00 00 00       	call   80105dd0 <trap>
  addl $4, %esp
...
80105d37:	c7 04 c5 c2 4c 11 80 	movl   $0x8e000008,-0x7feeb33e(,%eax,8)
80105d3e:	08 00 00 8e 
80105d42:	66 89 14 c5 c0 4c 11 	mov    %dx,-0x7feeb340(,%eax,8)
80105d49:	80 
80105d4a:	c1 ea 10             	shr    $0x10,%edx
80105d4d:	66 89 14 c5 c6 4c 11 	mov    %dx,-0x7feeb33a(,%eax,8)
80105d54:	80 
  for(i = 0; i < 256; i++)
...
80105d5f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105d62:	a1 08 b1 10 80       	mov    0x8010b108,%eax
80105d67:	c7 05 c2 4e 11 80 08 	movl   $0xef000008,0x80114ec2
80105d6e:	00 00 ef 
  initlock(&tickslock, "time");
80105d71:	68 cc 7f 10 80       	push   $0x80107fcc
80105d76:	68 80 4c 11 80       	push   $0x80114c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105d7b:	66 a3 c0 4e 11 80    	mov    %ax,0x80114ec0
80105d81:	c1 e8 10             	shr    $0x10,%eax
80105d84:	66 a3 c6 4e 11 80    	mov    %ax,0x80114ec6
  initlock(&tickslock, "time");
80105d8a:	e8 01 e9 ff ff       	call   80104690 <initlock>
}
...
80105dab:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105daf:	b8 c0 4c 11 80       	mov    $0x80114cc0,%eax
...
80105dd9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105ddc:	8b 43 30             	mov    0x30(%ebx),%eax
80105ddf:	83 f8 40             	cmp    $0x40,%eax
80105de2:	0f 84 78 01 00 00    	je     80105f60 <trap+0x190>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105dee:	0f 87 8c 00 00 00    	ja     80105e80 <trap+0xb0>
80105df4:	ff 24 85 74 80 10 80 	jmp    *-0x7fef7f8c(,%eax,4)
...
80105e0a:	e8 f1 db ff ff       	call   80103a00 <myproc>
80105e0f:	85 c0                	test   %eax,%eax
80105e11:	74 1d                	je     80105e30 <trap+0x60>
80105e13:	e8 e8 db ff ff       	call   80103a00 <myproc>
80105e18:	8b 50 24             	mov    0x24(%eax),%edx
80105e1b:	85 d2                	test   %edx,%edx
80105e1d:	74 11                	je     80105e30 <trap+0x60>
80105e1f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105e23:	83 e0 03             	and    $0x3,%eax
80105e26:	66 83 f8 03          	cmp    $0x3,%ax
80105e2a:	0f 84 f8 01 00 00    	je     80106028 <trap+0x258>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105e30:	e8 cb db ff ff       	call   80103a00 <myproc>
80105e35:	85 c0                	test   %eax,%eax
80105e37:	74 0f                	je     80105e48 <trap+0x78>
80105e39:	e8 c2 db ff ff       	call   80103a00 <myproc>
80105e3e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105e42:	0f 84 c8 00 00 00    	je     80105f10 <trap+0x140>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e48:	e8 b3 db ff ff       	call   80103a00 <myproc>
80105e4d:	85 c0                	test   %eax,%eax
80105e4f:	74 1d                	je     80105e6e <trap+0x9e>
80105e51:	e8 aa db ff ff       	call   80103a00 <myproc>
80105e56:	8b 40 24             	mov    0x24(%eax),%eax
80105e59:	85 c0                	test   %eax,%eax
80105e5b:	74 11                	je     80105e6e <trap+0x9e>
80105e5d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105e61:	83 e0 03             	and    $0x3,%eax
80105e64:	66 83 f8 03          	cmp    $0x3,%ax
80105e68:	0f 84 1f 01 00 00    	je     80105f8d <trap+0x1bd>
    exit();
}
...
80105e80:	e8 7b db ff ff       	call   80103a00 <myproc>
80105e85:	85 c0                	test   %eax,%eax
80105e87:	0f 84 28 02 00 00    	je     801060b5 <trap+0x2e5>
80105e8d:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105e91:	0f 84 1e 02 00 00    	je     801060b5 <trap+0x2e5>
    if(tf->trapno==T_PGFLT){//checking wheather there is page fault or not
80105e97:	83 7b 30 0e          	cmpl   $0xe,0x30(%ebx)
80105e9b:	0f 84 97 01 00 00    	je     80106038 <trap+0x268>
...
80105ea1:	0f 20 d1             	mov    %cr2,%ecx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ea4:	8b 53 38             	mov    0x38(%ebx),%edx
80105ea7:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105eaa:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105ead:	e8 2e db ff ff       	call   801039e0 <cpuid>
80105eb2:	8b 73 30             	mov    0x30(%ebx),%esi
80105eb5:	89 c7                	mov    %eax,%edi
80105eb7:	8b 43 34             	mov    0x34(%ebx),%eax
80105eba:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80105ebd:	e8 3e db ff ff       	call   80103a00 <myproc>
80105ec2:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105ec5:	e8 36 db ff ff       	call   80103a00 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105ed3:	ff 75 e4             	push   -0x1c(%ebp)
...
80105ede:	ff 70 10             	push   0x10(%eax)
80105ee1:	68 30 80 10 80       	push   $0x80108030
80105ee6:	e8 b5 a7 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105eeb:	83 c4 20             	add    $0x20,%esp
80105eee:	e8 0d db ff ff       	call   80103a00 <myproc>
80105ef3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105efa:	e8 01 db ff ff       	call   80103a00 <myproc>
80105eff:	85 c0                	test   %eax,%eax
80105f01:	0f 85 0c ff ff ff    	jne    80105e13 <trap+0x43>
80105f07:	e9 24 ff ff ff       	jmp    80105e30 <trap+0x60>
80105f0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105f10:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105f14:	0f 85 2e ff ff ff    	jne    80105e48 <trap+0x78>
    yield();
80105f1a:	e8 91 e3 ff ff       	call   801042b0 <yield>
80105f1f:	e9 24 ff ff ff       	jmp    80105e48 <trap+0x78>
...
80105f2f:	e8 ac da ff ff       	call   801039e0 <cpuid>
80105f34:	57                   	push   %edi
80105f35:	56                   	push   %esi
80105f36:	50                   	push   %eax
80105f37:	68 d8 7f 10 80       	push   $0x80107fd8
...
80105f46:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f49:	e8 b2 da ff ff       	call   80103a00 <myproc>
80105f4e:	85 c0                	test   %eax,%eax
80105f50:	0f 85 bd fe ff ff    	jne    80105e13 <trap+0x43>
80105f56:	e9 d5 fe ff ff       	jmp    80105e30 <trap+0x60>
80105f5b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105f5f:	90                   	nop
    if(myproc()->killed)
80105f60:	e8 9b da ff ff       	call   80103a00 <myproc>
80105f65:	8b 70 24             	mov    0x24(%eax),%esi
80105f68:	85 f6                	test   %esi,%esi
80105f6a:	0f 85 18 01 00 00    	jne    80106088 <trap+0x2b8>
    myproc()->tf = tf;
80105f70:	e8 8b da ff ff       	call   80103a00 <myproc>
80105f75:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105f78:	e8 a3 ed ff ff       	call   80104d20 <syscall>
    if(myproc()->killed)
80105f7d:	e8 7e da ff ff       	call   80103a00 <myproc>
80105f82:	8b 48 24             	mov    0x24(%eax),%ecx
80105f85:	85 c9                	test   %ecx,%ecx
80105f87:	0f 84 e1 fe ff ff    	je     80105e6e <trap+0x9e>
}
...
80105f93:	5d                   	pop    %ebp
      exit();
80105f94:	e9 b7 e0 ff ff       	jmp    80104050 <exit>
80105f99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105fa0:	e8 ab 02 00 00       	call   80106250 <uartintr>
    lapiceoi();
80105fa5:	e8 66 c9 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105faa:	e8 51 da ff ff       	call   80103a00 <myproc>
80105faf:	85 c0                	test   %eax,%eax
80105fb1:	0f 85 5c fe ff ff    	jne    80105e13 <trap+0x43>
80105fb7:	e9 74 fe ff ff       	jmp    80105e30 <trap+0x60>
...
80105fc5:	e8 46 c9 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105fca:	e8 31 da ff ff       	call   80103a00 <myproc>
80105fcf:	85 c0                	test   %eax,%eax
80105fd1:	0f 85 3c fe ff ff    	jne    80105e13 <trap+0x43>
80105fd7:	e9 54 fe ff ff       	jmp    80105e30 <trap+0x60>
80105fdc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105fe0:	e8 fb d9 ff ff       	call   801039e0 <cpuid>
80105fe5:	85 c0                	test   %eax,%eax
80105fe7:	0f 85 18 fe ff ff    	jne    80105e05 <trap+0x35>
      acquire(&tickslock);
80105fed:	83 ec 0c             	sub    $0xc,%esp
80105ff0:	68 80 4c 11 80       	push   $0x80114c80
80105ff5:	e8 66 e8 ff ff       	call   80104860 <acquire>
      wakeup(&ticks);
80105ffa:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
      ticks++;
80106001:	83 05 60 4c 11 80 01 	addl   $0x1,0x80114c60
      wakeup(&ticks);
80106008:	e8 b3 e3 ff ff       	call   801043c0 <wakeup>
      release(&tickslock);
8010600d:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
80106014:	e8 e7 e7 ff ff       	call   80104800 <release>
80106019:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
8010601c:	e9 e4 fd ff ff       	jmp    80105e05 <trap+0x35>
80106021:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80106028:	e8 23 e0 ff ff       	call   80104050 <exit>
8010602d:	e9 fe fd ff ff       	jmp    80105e30 <trap+0x60>
80106032:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80106038:	0f 20 d6             	mov    %cr2,%esi
	if(rcr2()<=myproc()->sz){ //checking wheather the faulting address is within the virtual address space of process or not
8010603b:	e8 c0 d9 ff ff       	call   80103a00 <myproc>
80106040:	39 30                	cmp    %esi,(%eax)
80106042:	72 54                	jb     80106098 <trap+0x2c8>
80106044:	0f 20 d6             	mov    %cr2,%esi
80106047:	0f 20 d7             	mov    %cr2,%edi
	        if(allocuvm(myproc()->pgdir,old,(uint)rcr2()+PGSIZE)==0){
8010604a:	e8 b1 d9 ff ff       	call   80103a00 <myproc>
8010604f:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106055:	83 ec 04             	sub    $0x4,%esp
                uint old=PGROUNDDOWN((uint)rcr2());
80106058:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
	        if(allocuvm(myproc()->pgdir,old,(uint)rcr2()+PGSIZE)==0){
8010605e:	57                   	push   %edi
8010605f:	56                   	push   %esi
80106060:	ff 70 04             	push   0x4(%eax)
80106063:	e8 18 12 00 00       	call   80107280 <allocuvm>
80106068:	83 c4 10             	add    $0x10,%esp
8010606b:	85 c0                	test   %eax,%eax
8010606d:	74 3f                	je     801060ae <trap+0x2de>
	        switchuvm(myproc());
8010606f:	e8 8c d9 ff ff       	call   80103a00 <myproc>
80106074:	83 ec 0c             	sub    $0xc,%esp
80106077:	50                   	push   %eax
80106078:	e8 83 0f 00 00       	call   80107000 <switchuvm>
          break;}
8010607d:	83 c4 10             	add    $0x10,%esp
80106080:	e9 85 fd ff ff       	jmp    80105e0a <trap+0x3a>
80106085:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80106088:	e8 c3 df ff ff       	call   80104050 <exit>
8010608d:	e9 de fe ff ff       	jmp    80105f70 <trap+0x1a0>
80106092:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	myproc()->killed=1;
80106098:	e8 63 d9 ff ff       	call   80103a00 <myproc>
8010609d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
	exit();
801060a4:	e8 a7 df ff ff       	call   80104050 <exit>
801060a9:	e9 f3 fd ff ff       	jmp    80105ea1 <trap+0xd1>
					                                  exit();}
801060ae:	e8 9d df ff ff       	call   80104050 <exit>
801060b3:	eb ba                	jmp    8010606f <trap+0x29f>
801060b5:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801060b8:	8b 73 38             	mov    0x38(%ebx),%esi
801060bb:	e8 20 d9 ff ff       	call   801039e0 <cpuid>
801060c0:	83 ec 0c             	sub    $0xc,%esp
801060c3:	57                   	push   %edi
801060c4:	56                   	push   %esi
801060c5:	50                   	push   %eax
801060c6:	ff 73 30             	push   0x30(%ebx)
801060c9:	68 fc 7f 10 80       	push   $0x80107ffc
801060ce:	e8 cd a5 ff ff       	call   801006a0 <cprintf>
      panic("trap");
801060d3:	83 c4 14             	add    $0x14,%esp
801060d6:	68 d1 7f 10 80       	push   $0x80107fd1
801060db:	e8 a0 a2 ff ff       	call   80100380 <panic>
...
80106167:	74 78                	je     801061e1 <uartinit+0xd1>
  uart = 1;
80106169:	c7 05 c0 54 11 80 01 	movl   $0x1,0x801154c0
80106170:	00 00 00 
...
8010617c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010617f:	bf f4 80 10 80       	mov    $0x801080f4,%edi
...
80106267:	6a 00                	push   $0x0
  jmp alltraps
80106269:	e9 8c fa ff ff       	jmp    80105cfa <alltraps>
...
80106270:	6a 01                	push   $0x1
  jmp alltraps
80106272:	e9 83 fa ff ff       	jmp    80105cfa <alltraps>
...
80106279:	6a 02                	push   $0x2
  jmp alltraps
8010627b:	e9 7a fa ff ff       	jmp    80105cfa <alltraps>
...
8010628b:	6a 04                	push   $0x4
  jmp alltraps
8010628d:	e9 68 fa ff ff       	jmp    80105cfa <alltraps>
...
80106294:	6a 05                	push   $0x5
  jmp alltraps
80106296:	e9 5f fa ff ff       	jmp    80105cfa <alltraps>
...
8010629d:	6a 06                	push   $0x6
  jmp alltraps
8010629f:	e9 56 fa ff ff       	jmp    80105cfa <alltraps>
...
801062a6:	6a 07                	push   $0x7
  jmp alltraps
801062a8:	e9 4d fa ff ff       	jmp    80105cfa <alltraps>
...
801062ad:	6a 08                	push   $0x8
  jmp alltraps
801062af:	e9 46 fa ff ff       	jmp    80105cfa <alltraps>
...
801062b6:	6a 09                	push   $0x9
  jmp alltraps
801062b8:	e9 3d fa ff ff       	jmp    80105cfa <alltraps>
...
801062c4:	6a 0b                	push   $0xb
  jmp alltraps
801062c6:	e9 2f fa ff ff       	jmp    80105cfa <alltraps>
...
801062cb:	6a 0c                	push   $0xc
  jmp alltraps
801062cd:	e9 28 fa ff ff       	jmp    80105cfa <alltraps>
...
801062d2:	6a 0d                	push   $0xd
  jmp alltraps
801062d4:	e9 21 fa ff ff       	jmp    80105cfa <alltraps>
...
801062d9:	6a 0e                	push   $0xe
  jmp alltraps
801062db:	e9 1a fa ff ff       	jmp    80105cfa <alltraps>
...
801062e2:	6a 0f                	push   $0xf
  jmp alltraps
801062e4:	e9 11 fa ff ff       	jmp    80105cfa <alltraps>
...
801062eb:	6a 10                	push   $0x10
  jmp alltraps
801062ed:	e9 08 fa ff ff       	jmp    80105cfa <alltraps>
...
801062f2:	6a 11                	push   $0x11
  jmp alltraps
801062f4:	e9 01 fa ff ff       	jmp    80105cfa <alltraps>
...
801062fb:	6a 12                	push   $0x12
  jmp alltraps
801062fd:	e9 f8 f9 ff ff       	jmp    80105cfa <alltraps>
...
80106304:	6a 13                	push   $0x13
  jmp alltraps
80106306:	e9 ef f9 ff ff       	jmp    80105cfa <alltraps>
...
8010630d:	6a 14                	push   $0x14
  jmp alltraps
8010630f:	e9 e6 f9 ff ff       	jmp    80105cfa <alltraps>
...
80106316:	6a 15                	push   $0x15
  jmp alltraps
80106318:	e9 dd f9 ff ff       	jmp    80105cfa <alltraps>
...
8010631f:	6a 16                	push   $0x16
  jmp alltraps
80106321:	e9 d4 f9 ff ff       	jmp    80105cfa <alltraps>
...
80106328:	6a 17                	push   $0x17
  jmp alltraps
8010632a:	e9 cb f9 ff ff       	jmp    80105cfa <alltraps>
...
80106331:	6a 18                	push   $0x18
  jmp alltraps
80106333:	e9 c2 f9 ff ff       	jmp    80105cfa <alltraps>
...
8010633a:	6a 19                	push   $0x19
  jmp alltraps
8010633c:	e9 b9 f9 ff ff       	jmp    80105cfa <alltraps>
...
80106343:	6a 1a                	push   $0x1a
  jmp alltraps
80106345:	e9 b0 f9 ff ff       	jmp    80105cfa <alltraps>
...
8010634c:	6a 1b                	push   $0x1b
  jmp alltraps
8010634e:	e9 a7 f9 ff ff       	jmp    80105cfa <alltraps>
...
80106355:	6a 1c                	push   $0x1c
  jmp alltraps
80106357:	e9 9e f9 ff ff       	jmp    80105cfa <alltraps>
...
8010635e:	6a 1d                	push   $0x1d
  jmp alltraps
80106360:	e9 95 f9 ff ff       	jmp    80105cfa <alltraps>
...
80106367:	6a 1e                	push   $0x1e
  jmp alltraps
80106369:	e9 8c f9 ff ff       	jmp    80105cfa <alltraps>
...
80106370:	6a 1f                	push   $0x1f
  jmp alltraps
80106372:	e9 83 f9 ff ff       	jmp    80105cfa <alltraps>
...
80106379:	6a 20                	push   $0x20
  jmp alltraps
8010637b:	e9 7a f9 ff ff       	jmp    80105cfa <alltraps>
...
80106382:	6a 21                	push   $0x21
  jmp alltraps
80106384:	e9 71 f9 ff ff       	jmp    80105cfa <alltraps>
...
8010638b:	6a 22                	push   $0x22
  jmp alltraps
8010638d:	e9 68 f9 ff ff       	jmp    80105cfa <alltraps>
...
80106394:	6a 23                	push   $0x23
  jmp alltraps
80106396:	e9 5f f9 ff ff       	jmp    80105cfa <alltraps>
...
8010639d:	6a 24                	push   $0x24
  jmp alltraps
8010639f:	e9 56 f9 ff ff       	jmp    80105cfa <alltraps>
...
801063a6:	6a 25                	push   $0x25
  jmp alltraps
801063a8:	e9 4d f9 ff ff       	jmp    80105cfa <alltraps>
...
801063af:	6a 26                	push   $0x26
  jmp alltraps
801063b1:	e9 44 f9 ff ff       	jmp    80105cfa <alltraps>
...
801063b8:	6a 27                	push   $0x27
  jmp alltraps
801063ba:	e9 3b f9 ff ff       	jmp    80105cfa <alltraps>
...
801063c1:	6a 28                	push   $0x28
  jmp alltraps
801063c3:	e9 32 f9 ff ff       	jmp    80105cfa <alltraps>
...
801063ca:	6a 29                	push   $0x29
  jmp alltraps
801063cc:	e9 29 f9 ff ff       	jmp    80105cfa <alltraps>
...
801063d3:	6a 2a                	push   $0x2a
  jmp alltraps
801063d5:	e9 20 f9 ff ff       	jmp    80105cfa <alltraps>
...
801063dc:	6a 2b                	push   $0x2b
  jmp alltraps
801063de:	e9 17 f9 ff ff       	jmp    80105cfa <alltraps>
...
801063e5:	6a 2c                	push   $0x2c
  jmp alltraps
801063e7:	e9 0e f9 ff ff       	jmp    80105cfa <alltraps>
...
801063ee:	6a 2d                	push   $0x2d
  jmp alltraps
801063f0:	e9 05 f9 ff ff       	jmp    80105cfa <alltraps>
...
801063f7:	6a 2e                	push   $0x2e
  jmp alltraps
801063f9:	e9 fc f8 ff ff       	jmp    80105cfa <alltraps>
...
80106400:	6a 2f                	push   $0x2f
  jmp alltraps
80106402:	e9 f3 f8 ff ff       	jmp    80105cfa <alltraps>
...
80106409:	6a 30                	push   $0x30
  jmp alltraps
8010640b:	e9 ea f8 ff ff       	jmp    80105cfa <alltraps>
...
80106412:	6a 31                	push   $0x31
  jmp alltraps
80106414:	e9 e1 f8 ff ff       	jmp    80105cfa <alltraps>
...
8010641b:	6a 32                	push   $0x32
  jmp alltraps
8010641d:	e9 d8 f8 ff ff       	jmp    80105cfa <alltraps>
...
80106424:	6a 33                	push   $0x33
  jmp alltraps
80106426:	e9 cf f8 ff ff       	jmp    80105cfa <alltraps>
...
8010642d:	6a 34                	push   $0x34
  jmp alltraps
8010642f:	e9 c6 f8 ff ff       	jmp    80105cfa <alltraps>
...
80106436:	6a 35                	push   $0x35
  jmp alltraps
80106438:	e9 bd f8 ff ff       	jmp    80105cfa <alltraps>
...
8010643f:	6a 36                	push   $0x36
  jmp alltraps
80106441:	e9 b4 f8 ff ff       	jmp    80105cfa <alltraps>
...
80106448:	6a 37                	push   $0x37
  jmp alltraps
8010644a:	e9 ab f8 ff ff       	jmp    80105cfa <alltraps>
...
80106451:	6a 38                	push   $0x38
  jmp alltraps
80106453:	e9 a2 f8 ff ff       	jmp    80105cfa <alltraps>
...
8010645a:	6a 39                	push   $0x39
  jmp alltraps
8010645c:	e9 99 f8 ff ff       	jmp    80105cfa <alltraps>
...
80106463:	6a 3a                	push   $0x3a
  jmp alltraps
80106465:	e9 90 f8 ff ff       	jmp    80105cfa <alltraps>
...
8010646c:	6a 3b                	push   $0x3b
  jmp alltraps
8010646e:	e9 87 f8 ff ff       	jmp    80105cfa <alltraps>
...
80106475:	6a 3c                	push   $0x3c
  jmp alltraps
80106477:	e9 7e f8 ff ff       	jmp    80105cfa <alltraps>
...
8010647e:	6a 3d                	push   $0x3d
  jmp alltraps
80106480:	e9 75 f8 ff ff       	jmp    80105cfa <alltraps>
...
80106487:	6a 3e                	push   $0x3e
  jmp alltraps
80106489:	e9 6c f8 ff ff       	jmp    80105cfa <alltraps>
...
80106490:	6a 3f                	push   $0x3f
  jmp alltraps
80106492:	e9 63 f8 ff ff       	jmp    80105cfa <alltraps>
...
80106499:	6a 40                	push   $0x40
  jmp alltraps
8010649b:	e9 5a f8 ff ff       	jmp    80105cfa <alltraps>
...
801064a2:	6a 41                	push   $0x41
  jmp alltraps
801064a4:	e9 51 f8 ff ff       	jmp    80105cfa <alltraps>
...
801064ab:	6a 42                	push   $0x42
  jmp alltraps
801064ad:	e9 48 f8 ff ff       	jmp    80105cfa <alltraps>
...
801064b4:	6a 43                	push   $0x43
  jmp alltraps
801064b6:	e9 3f f8 ff ff       	jmp    80105cfa <alltraps>
...
801064bd:	6a 44                	push   $0x44
  jmp alltraps
801064bf:	e9 36 f8 ff ff       	jmp    80105cfa <alltraps>
...
801064c6:	6a 45                	push   $0x45
  jmp alltraps
801064c8:	e9 2d f8 ff ff       	jmp    80105cfa <alltraps>
...
801064cf:	6a 46                	push   $0x46
  jmp alltraps
801064d1:	e9 24 f8 ff ff       	jmp    80105cfa <alltraps>
...
801064d8:	6a 47                	push   $0x47
  jmp alltraps
801064da:	e9 1b f8 ff ff       	jmp    80105cfa <alltraps>
...
801064e1:	6a 48                	push   $0x48
  jmp alltraps
801064e3:	e9 12 f8 ff ff       	jmp    80105cfa <alltraps>
...
801064ea:	6a 49                	push   $0x49
  jmp alltraps
801064ec:	e9 09 f8 ff ff       	jmp    80105cfa <alltraps>
...
801064f3:	6a 4a                	push   $0x4a
  jmp alltraps
801064f5:	e9 00 f8 ff ff       	jmp    80105cfa <alltraps>
...
801064fc:	6a 4b                	push   $0x4b
  jmp alltraps
801064fe:	e9 f7 f7 ff ff       	jmp    80105cfa <alltraps>
...
80106505:	6a 4c                	push   $0x4c
  jmp alltraps
80106507:	e9 ee f7 ff ff       	jmp    80105cfa <alltraps>
...
8010650e:	6a 4d                	push   $0x4d
  jmp alltraps
80106510:	e9 e5 f7 ff ff       	jmp    80105cfa <alltraps>
...
80106517:	6a 4e                	push   $0x4e
  jmp alltraps
80106519:	e9 dc f7 ff ff       	jmp    80105cfa <alltraps>
...
80106520:	6a 4f                	push   $0x4f
  jmp alltraps
80106522:	e9 d3 f7 ff ff       	jmp    80105cfa <alltraps>
...
80106529:	6a 50                	push   $0x50
  jmp alltraps
8010652b:	e9 ca f7 ff ff       	jmp    80105cfa <alltraps>
...
80106532:	6a 51                	push   $0x51
  jmp alltraps
80106534:	e9 c1 f7 ff ff       	jmp    80105cfa <alltraps>
...
8010653b:	6a 52                	push   $0x52
  jmp alltraps
8010653d:	e9 b8 f7 ff ff       	jmp    80105cfa <alltraps>
...
80106544:	6a 53                	push   $0x53
  jmp alltraps
80106546:	e9 af f7 ff ff       	jmp    80105cfa <alltraps>
...
8010654d:	6a 54                	push   $0x54
  jmp alltraps
8010654f:	e9 a6 f7 ff ff       	jmp    80105cfa <alltraps>
...
80106556:	6a 55                	push   $0x55
  jmp alltraps
80106558:	e9 9d f7 ff ff       	jmp    80105cfa <alltraps>
...
8010655f:	6a 56                	push   $0x56
  jmp alltraps
80106561:	e9 94 f7 ff ff       	jmp    80105cfa <alltraps>
...
80106568:	6a 57                	push   $0x57
  jmp alltraps
8010656a:	e9 8b f7 ff ff       	jmp    80105cfa <alltraps>
...
80106571:	6a 58                	push   $0x58
  jmp alltraps
80106573:	e9 82 f7 ff ff       	jmp    80105cfa <alltraps>
...
8010657a:	6a 59                	push   $0x59
  jmp alltraps
8010657c:	e9 79 f7 ff ff       	jmp    80105cfa <alltraps>
...
80106583:	6a 5a                	push   $0x5a
  jmp alltraps
80106585:	e9 70 f7 ff ff       	jmp    80105cfa <alltraps>
...
8010658c:	6a 5b                	push   $0x5b
  jmp alltraps
8010658e:	e9 67 f7 ff ff       	jmp    80105cfa <alltraps>
...
80106595:	6a 5c                	push   $0x5c
  jmp alltraps
80106597:	e9 5e f7 ff ff       	jmp    80105cfa <alltraps>
...
8010659e:	6a 5d                	push   $0x5d
  jmp alltraps
801065a0:	e9 55 f7 ff ff       	jmp    80105cfa <alltraps>
...
801065a7:	6a 5e                	push   $0x5e
  jmp alltraps
801065a9:	e9 4c f7 ff ff       	jmp    80105cfa <alltraps>
...
801065b0:	6a 5f                	push   $0x5f
  jmp alltraps
801065b2:	e9 43 f7 ff ff       	jmp    80105cfa <alltraps>
...
801065b9:	6a 60                	push   $0x60
  jmp alltraps
801065bb:	e9 3a f7 ff ff       	jmp    80105cfa <alltraps>
...
801065c2:	6a 61                	push   $0x61
  jmp alltraps
801065c4:	e9 31 f7 ff ff       	jmp    80105cfa <alltraps>
...
801065cb:	6a 62                	push   $0x62
  jmp alltraps
801065cd:	e9 28 f7 ff ff       	jmp    80105cfa <alltraps>
...
801065d4:	6a 63                	push   $0x63
  jmp alltraps
801065d6:	e9 1f f7 ff ff       	jmp    80105cfa <alltraps>
...
801065dd:	6a 64                	push   $0x64
  jmp alltraps
801065df:	e9 16 f7 ff ff       	jmp    80105cfa <alltraps>
...
801065e6:	6a 65                	push   $0x65
  jmp alltraps
801065e8:	e9 0d f7 ff ff       	jmp    80105cfa <alltraps>
...
801065ef:	6a 66                	push   $0x66
  jmp alltraps
801065f1:	e9 04 f7 ff ff       	jmp    80105cfa <alltraps>
...
801065f8:	6a 67                	push   $0x67
  jmp alltraps
801065fa:	e9 fb f6 ff ff       	jmp    80105cfa <alltraps>
...
80106601:	6a 68                	push   $0x68
  jmp alltraps
80106603:	e9 f2 f6 ff ff       	jmp    80105cfa <alltraps>
...
8010660a:	6a 69                	push   $0x69
  jmp alltraps
8010660c:	e9 e9 f6 ff ff       	jmp    80105cfa <alltraps>
...
80106613:	6a 6a                	push   $0x6a
  jmp alltraps
80106615:	e9 e0 f6 ff ff       	jmp    80105cfa <alltraps>
...
8010661c:	6a 6b                	push   $0x6b
  jmp alltraps
8010661e:	e9 d7 f6 ff ff       	jmp    80105cfa <alltraps>
...
80106625:	6a 6c                	push   $0x6c
  jmp alltraps
80106627:	e9 ce f6 ff ff       	jmp    80105cfa <alltraps>
...
8010662e:	6a 6d                	push   $0x6d
  jmp alltraps
80106630:	e9 c5 f6 ff ff       	jmp    80105cfa <alltraps>
...
80106637:	6a 6e                	push   $0x6e
  jmp alltraps
80106639:	e9 bc f6 ff ff       	jmp    80105cfa <alltraps>
...
80106640:	6a 6f                	push   $0x6f
  jmp alltraps
80106642:	e9 b3 f6 ff ff       	jmp    80105cfa <alltraps>
...
80106649:	6a 70                	push   $0x70
  jmp alltraps
8010664b:	e9 aa f6 ff ff       	jmp    80105cfa <alltraps>
...
80106652:	6a 71                	push   $0x71
  jmp alltraps
80106654:	e9 a1 f6 ff ff       	jmp    80105cfa <alltraps>
...
8010665b:	6a 72                	push   $0x72
  jmp alltraps
8010665d:	e9 98 f6 ff ff       	jmp    80105cfa <alltraps>
...
80106664:	6a 73                	push   $0x73
  jmp alltraps
80106666:	e9 8f f6 ff ff       	jmp    80105cfa <alltraps>
...
8010666d:	6a 74                	push   $0x74
  jmp alltraps
8010666f:	e9 86 f6 ff ff       	jmp    80105cfa <alltraps>
...
80106676:	6a 75                	push   $0x75
  jmp alltraps
80106678:	e9 7d f6 ff ff       	jmp    80105cfa <alltraps>
...
8010667f:	6a 76                	push   $0x76
  jmp alltraps
80106681:	e9 74 f6 ff ff       	jmp    80105cfa <alltraps>
...
80106688:	6a 77                	push   $0x77
  jmp alltraps
8010668a:	e9 6b f6 ff ff       	jmp    80105cfa <alltraps>
...
80106691:	6a 78                	push   $0x78
  jmp alltraps
80106693:	e9 62 f6 ff ff       	jmp    80105cfa <alltraps>
...
8010669a:	6a 79                	push   $0x79
  jmp alltraps
8010669c:	e9 59 f6 ff ff       	jmp    80105cfa <alltraps>
...
801066a3:	6a 7a                	push   $0x7a
  jmp alltraps
801066a5:	e9 50 f6 ff ff       	jmp    80105cfa <alltraps>
...
801066ac:	6a 7b                	push   $0x7b
  jmp alltraps
801066ae:	e9 47 f6 ff ff       	jmp    80105cfa <alltraps>
...
801066b5:	6a 7c                	push   $0x7c
  jmp alltraps
801066b7:	e9 3e f6 ff ff       	jmp    80105cfa <alltraps>
...
801066be:	6a 7d                	push   $0x7d
  jmp alltraps
801066c0:	e9 35 f6 ff ff       	jmp    80105cfa <alltraps>
...
801066c7:	6a 7e                	push   $0x7e
  jmp alltraps
801066c9:	e9 2c f6 ff ff       	jmp    80105cfa <alltraps>
...
801066d0:	6a 7f                	push   $0x7f
  jmp alltraps
801066d2:	e9 23 f6 ff ff       	jmp    80105cfa <alltraps>
...
801066d9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801066de:	e9 17 f6 ff ff       	jmp    80105cfa <alltraps>
...
801066e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801066ea:	e9 0b f6 ff ff       	jmp    80105cfa <alltraps>
...
801066f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801066f6:	e9 ff f5 ff ff       	jmp    80105cfa <alltraps>
...
801066fd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106702:	e9 f3 f5 ff ff       	jmp    80105cfa <alltraps>
...
80106709:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010670e:	e9 e7 f5 ff ff       	jmp    80105cfa <alltraps>
...
80106715:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010671a:	e9 db f5 ff ff       	jmp    80105cfa <alltraps>
...
80106721:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106726:	e9 cf f5 ff ff       	jmp    80105cfa <alltraps>
...
8010672d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106732:	e9 c3 f5 ff ff       	jmp    80105cfa <alltraps>
...
80106739:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010673e:	e9 b7 f5 ff ff       	jmp    80105cfa <alltraps>
...
80106745:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010674a:	e9 ab f5 ff ff       	jmp    80105cfa <alltraps>
...
80106751:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106756:	e9 9f f5 ff ff       	jmp    80105cfa <alltraps>
...
8010675d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106762:	e9 93 f5 ff ff       	jmp    80105cfa <alltraps>
...
80106769:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010676e:	e9 87 f5 ff ff       	jmp    80105cfa <alltraps>
...
80106775:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010677a:	e9 7b f5 ff ff       	jmp    80105cfa <alltraps>
...
80106781:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106786:	e9 6f f5 ff ff       	jmp    80105cfa <alltraps>
...
8010678d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106792:	e9 63 f5 ff ff       	jmp    80105cfa <alltraps>
...
80106799:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010679e:	e9 57 f5 ff ff       	jmp    80105cfa <alltraps>
...
801067a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801067aa:	e9 4b f5 ff ff       	jmp    80105cfa <alltraps>
...
801067b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801067b6:	e9 3f f5 ff ff       	jmp    80105cfa <alltraps>
...
801067bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801067c2:	e9 33 f5 ff ff       	jmp    80105cfa <alltraps>
...
801067c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801067ce:	e9 27 f5 ff ff       	jmp    80105cfa <alltraps>
...
801067d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801067da:	e9 1b f5 ff ff       	jmp    80105cfa <alltraps>
...
801067e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801067e6:	e9 0f f5 ff ff       	jmp    80105cfa <alltraps>
...
801067ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801067f2:	e9 03 f5 ff ff       	jmp    80105cfa <alltraps>
...
801067f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801067fe:	e9 f7 f4 ff ff       	jmp    80105cfa <alltraps>
...
80106805:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010680a:	e9 eb f4 ff ff       	jmp    80105cfa <alltraps>
...
80106811:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106816:	e9 df f4 ff ff       	jmp    80105cfa <alltraps>
...
8010681d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106822:	e9 d3 f4 ff ff       	jmp    80105cfa <alltraps>
...
80106829:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010682e:	e9 c7 f4 ff ff       	jmp    80105cfa <alltraps>
...
80106835:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010683a:	e9 bb f4 ff ff       	jmp    80105cfa <alltraps>
...
80106841:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106846:	e9 af f4 ff ff       	jmp    80105cfa <alltraps>
...
8010684d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106852:	e9 a3 f4 ff ff       	jmp    80105cfa <alltraps>
...
80106859:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010685e:	e9 97 f4 ff ff       	jmp    80105cfa <alltraps>
...
80106865:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010686a:	e9 8b f4 ff ff       	jmp    80105cfa <alltraps>
...
80106871:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106876:	e9 7f f4 ff ff       	jmp    80105cfa <alltraps>
...
8010687d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106882:	e9 73 f4 ff ff       	jmp    80105cfa <alltraps>
...
80106889:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010688e:	e9 67 f4 ff ff       	jmp    80105cfa <alltraps>
...
80106895:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010689a:	e9 5b f4 ff ff       	jmp    80105cfa <alltraps>
...
801068a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801068a6:	e9 4f f4 ff ff       	jmp    80105cfa <alltraps>
...
801068ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801068b2:	e9 43 f4 ff ff       	jmp    80105cfa <alltraps>
...
801068b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801068be:	e9 37 f4 ff ff       	jmp    80105cfa <alltraps>
...
801068c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801068ca:	e9 2b f4 ff ff       	jmp    80105cfa <alltraps>
...
801068d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801068d6:	e9 1f f4 ff ff       	jmp    80105cfa <alltraps>
...
801068dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801068e2:	e9 13 f4 ff ff       	jmp    80105cfa <alltraps>
...
801068e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801068ee:	e9 07 f4 ff ff       	jmp    80105cfa <alltraps>
...
801068f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801068fa:	e9 fb f3 ff ff       	jmp    80105cfa <alltraps>
...
80106901:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106906:	e9 ef f3 ff ff       	jmp    80105cfa <alltraps>
...
8010690d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106912:	e9 e3 f3 ff ff       	jmp    80105cfa <alltraps>
...
80106919:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010691e:	e9 d7 f3 ff ff       	jmp    80105cfa <alltraps>
...
80106925:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010692a:	e9 cb f3 ff ff       	jmp    80105cfa <alltraps>
...
80106931:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106936:	e9 bf f3 ff ff       	jmp    80105cfa <alltraps>
...
8010693d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106942:	e9 b3 f3 ff ff       	jmp    80105cfa <alltraps>
...
80106949:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010694e:	e9 a7 f3 ff ff       	jmp    80105cfa <alltraps>
...
80106955:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010695a:	e9 9b f3 ff ff       	jmp    80105cfa <alltraps>
...
80106961:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106966:	e9 8f f3 ff ff       	jmp    80105cfa <alltraps>
...
8010696d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106972:	e9 83 f3 ff ff       	jmp    80105cfa <alltraps>
...
80106979:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010697e:	e9 77 f3 ff ff       	jmp    80105cfa <alltraps>
...
80106985:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010698a:	e9 6b f3 ff ff       	jmp    80105cfa <alltraps>
...
80106991:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106996:	e9 5f f3 ff ff       	jmp    80105cfa <alltraps>
...
8010699d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801069a2:	e9 53 f3 ff ff       	jmp    80105cfa <alltraps>
...
801069a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801069ae:	e9 47 f3 ff ff       	jmp    80105cfa <alltraps>
...
801069b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801069ba:	e9 3b f3 ff ff       	jmp    80105cfa <alltraps>
...
801069c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801069c6:	e9 2f f3 ff ff       	jmp    80105cfa <alltraps>
...
801069cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801069d2:	e9 23 f3 ff ff       	jmp    80105cfa <alltraps>
...
801069d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801069de:	e9 17 f3 ff ff       	jmp    80105cfa <alltraps>
...
801069e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801069ea:	e9 0b f3 ff ff       	jmp    80105cfa <alltraps>
...
801069f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801069f6:	e9 ff f2 ff ff       	jmp    80105cfa <alltraps>
...
801069fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106a02:	e9 f3 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a09:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106a0e:	e9 e7 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a15:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106a1a:	e9 db f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a21:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106a26:	e9 cf f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a2d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106a32:	e9 c3 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a39:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106a3e:	e9 b7 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a45:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106a4a:	e9 ab f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a51:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106a56:	e9 9f f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a5d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106a62:	e9 93 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a69:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106a6e:	e9 87 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a75:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106a7a:	e9 7b f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a81:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106a86:	e9 6f f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a8d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106a92:	e9 63 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106a99:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106a9e:	e9 57 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106aa5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106aaa:	e9 4b f2 ff ff       	jmp    80105cfa <alltraps>
...
80106ab1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106ab6:	e9 3f f2 ff ff       	jmp    80105cfa <alltraps>
...
80106abd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106ac2:	e9 33 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106ac9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106ace:	e9 27 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106ad5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106ada:	e9 1b f2 ff ff       	jmp    80105cfa <alltraps>
...
80106ae1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106ae6:	e9 0f f2 ff ff       	jmp    80105cfa <alltraps>
...
80106aed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106af2:	e9 03 f2 ff ff       	jmp    80105cfa <alltraps>
...
80106af9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106afe:	e9 f7 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b05:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106b0a:	e9 eb f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b11:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106b16:	e9 df f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b1d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106b22:	e9 d3 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b29:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106b2e:	e9 c7 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b35:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106b3a:	e9 bb f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b41:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106b46:	e9 af f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b4d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106b52:	e9 a3 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b59:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106b5e:	e9 97 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b65:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106b6a:	e9 8b f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b71:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106b76:	e9 7f f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b7d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106b82:	e9 73 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b89:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106b8e:	e9 67 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106b95:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106b9a:	e9 5b f1 ff ff       	jmp    80105cfa <alltraps>
...
80106ba1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106ba6:	e9 4f f1 ff ff       	jmp    80105cfa <alltraps>
...
80106bad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106bb2:	e9 43 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106bb9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106bbe:	e9 37 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106bc5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106bca:	e9 2b f1 ff ff       	jmp    80105cfa <alltraps>
...
80106bd1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106bd6:	e9 1f f1 ff ff       	jmp    80105cfa <alltraps>
...
80106bdd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106be2:	e9 13 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106be9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106bee:	e9 07 f1 ff ff       	jmp    80105cfa <alltraps>
...
80106bf5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106bfa:	e9 fb f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c01:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106c06:	e9 ef f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c0d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106c12:	e9 e3 f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c19:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106c1e:	e9 d7 f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c25:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106c2a:	e9 cb f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c31:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106c36:	e9 bf f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c3d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106c42:	e9 b3 f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c49:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106c4e:	e9 a7 f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c55:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106c5a:	e9 9b f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c61:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106c66:	e9 8f f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c6d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106c72:	e9 83 f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c79:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106c7e:	e9 77 f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c85:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106c8a:	e9 6b f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c91:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106c96:	e9 5f f0 ff ff       	jmp    80105cfa <alltraps>
...
80106c9d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106ca2:	e9 53 f0 ff ff       	jmp    80105cfa <alltraps>
...
80106ca9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106cae:	e9 47 f0 ff ff       	jmp    80105cfa <alltraps>
...
80106cb5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106cba:	e9 3b f0 ff ff       	jmp    80105cfa <alltraps>
...
80106cc1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106cc6:	e9 2f f0 ff ff       	jmp    80105cfa <alltraps>
...
80106ccd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106cd2:	e9 23 f0 ff ff       	jmp    80105cfa <alltraps>
...
80106d7f:	68 26 7a 10 80       	push   $0x80107a26
...
80106e25:	e8 f6 da ff ff       	call   80104920 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106e6d:	68 fc 80 10 80       	push   $0x801080fc
...
80106e83:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106e86:	e8 55 cb ff ff       	call   801039e0 <cpuid>
  pd[0] = size-1;
...
80106f17:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &(myproc()->pgdir[PDX(va)]);
80106f1a:	e8 e1 ca ff ff       	call   80103a00 <myproc>
  if (*pde & PTE_P)
80106f1f:	8b 40 04             	mov    0x4(%eax),%eax
  pde = &(myproc()->pgdir[PDX(va)]);
80106f22:	89 da                	mov    %ebx,%edx
80106f24:	c1 ea 16             	shr    $0x16,%edx
  if (*pde & PTE_P)
80106f27:	8b 04 90             	mov    (%eax,%edx,4),%eax
80106f2a:	a8 01                	test   $0x1,%al
80106f2c:	74 32                	je     80106f60 <va2pa+0x50>
    uint add = PTE_ADDR(pgtab[PTX(va)]);
80106f2e:	89 da                	mov    %ebx,%edx
    pgtab = (pte_t *)P2V(PTE_ADDR(*pde));
80106f30:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    uint off = va & 0x00000FFF;
80106f35:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    uint add = PTE_ADDR(pgtab[PTX(va)]);
80106f3b:	c1 ea 0c             	shr    $0xc,%edx
80106f3e:	81 e2 ff 03 00 00    	and    $0x3ff,%edx
80106f44:	8b 84 90 00 00 00 80 	mov    -0x80000000(%eax,%edx,4),%eax
80106f4b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    return (add | off);
80106f50:	09 d8                	or     %ebx,%eax
}
80106f52:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106f55:	c9                   	leave  
80106f56:	c3                   	ret    
...
80106f65:	eb eb                	jmp    80106f52 <va2pa+0x42>
...
80106f76:	83 ec 18             	sub    $0x18,%esp
  struct proc *p = getProcess(pid);  // Retrieve the process PCB
80106f79:	ff 75 08             	push   0x8(%ebp)
80106f7c:	e8 ef cd ff ff       	call   80103d70 <getProcess>
  for (uint i = 0; i < PDX(KERNBASE); i++)
80106f81:	83 c4 10             	add    $0x10,%esp
  int count = 0;                   
80106f84:	31 c9                	xor    %ecx,%ecx
80106f86:	8b 70 04             	mov    0x4(%eax),%esi
80106f89:	8d be 00 08 00 00    	lea    0x800(%esi),%edi
80106f8f:	eb 0e                	jmp    80106f9f <getpasize+0x2f>
80106f91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for (uint i = 0; i < PDX(KERNBASE); i++)
80106f98:	83 c6 04             	add    $0x4,%esi
80106f9b:	39 fe                	cmp    %edi,%esi
80106f9d:	74 3a                	je     80106fd9 <getpasize+0x69>
    if (pgd[i] & PTE_P)
80106f9f:	8b 1e                	mov    (%esi),%ebx
80106fa1:	f6 c3 01             	test   $0x1,%bl
80106fa4:	74 f2                	je     80106f98 <getpasize+0x28>
      pte_t *pEn = (pte_t *)P2V(PTE_ADDR(pgd[i]));
80106fa6:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106fac:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
      for (uint j = 0; j < 1024; j++)
80106fb2:	81 eb 00 f0 ff 7f    	sub    $0x7ffff000,%ebx
80106fb8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106fbf:	90                   	nop
        if (pEn[j] & PTE_P)
80106fc0:	8b 10                	mov    (%eax),%edx
80106fc2:	83 e2 01             	and    $0x1,%edx
          count++;  // Increment the counter for each allocated page found.
80106fc5:	83 fa 01             	cmp    $0x1,%edx
80106fc8:	83 d9 ff             	sbb    $0xffffffff,%ecx
      for (uint j = 0; j < 1024; j++)
80106fcb:	83 c0 04             	add    $0x4,%eax
80106fce:	39 d8                	cmp    %ebx,%eax
80106fd0:	75 ee                	jne    80106fc0 <getpasize+0x50>
  for (uint i = 0; i < PDX(KERNBASE); i++)
80106fd2:	83 c6 04             	add    $0x4,%esi
80106fd5:	39 fe                	cmp    %edi,%esi
80106fd7:	75 c6                	jne    80106f9f <getpasize+0x2f>
}
80106fd9:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106fdc:	89 c8                	mov    %ecx,%eax
80106fde:	5b                   	pop    %ebx
80106fdf:	5e                   	pop    %esi
80106fe0:	5f                   	pop    %edi
80106fe1:	5d                   	pop    %ebp
80106fe2:	c3                   	ret    
80106fe3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106fea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80106ff0 <switchkvm>:
  lcr3(V2P(kpgdir)); // switch to the kernel page table
80106ff0:	a1 c4 54 11 80       	mov    0x801154c4,%eax
...
80107024:	0f 84 c2 00 00 00    	je     801070ec <switchuvm+0xec>
  pushcli();
8010702a:	e8 e1 d6 ff ff       	call   80104710 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010702f:	e8 4c c9 ff ff       	call   80103980 <mycpu>
80107034:	89 c3                	mov    %eax,%ebx
80107036:	e8 45 c9 ff ff       	call   80103980 <mycpu>
8010703b:	89 c7                	mov    %eax,%edi
8010703d:	e8 3e c9 ff ff       	call   80103980 <mycpu>
80107042:	83 c7 08             	add    $0x8,%edi
80107045:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107048:	e8 33 c9 ff ff       	call   80103980 <mycpu>
...
8010711c:	8b 75 10             	mov    0x10(%ebp),%esi
8010711f:	8b 7d 08             	mov    0x8(%ebp),%edi
80107122:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if (sz >= PGSIZE)
80107125:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010712b:	77 4b                	ja     80107178 <inituvm+0x68>
  mem = kalloc();
...
8010713f:	e8 dc d7 ff ff       	call   80104920 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W | PTE_U);
80107144:	58                   	pop    %eax
80107145:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010714b:	5a                   	pop    %edx
8010714c:	6a 06                	push   $0x6
8010714e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107153:	31 d2                	xor    %edx,%edx
80107155:	50                   	push   %eax
80107156:	89 f8                	mov    %edi,%eax
80107158:	e8 33 fc ff ff       	call   80106d90 <mappages>
  memmove(mem, init, sz);
8010715d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107160:	89 75 10             	mov    %esi,0x10(%ebp)
80107163:	83 c4 10             	add    $0x10,%esp
80107166:	89 5d 08             	mov    %ebx,0x8(%ebp)
80107169:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80107172:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107173:	e9 48 d8 ff ff       	jmp    801049c0 <memmove>
    panic("inituvm: more than a page");
80107178:	83 ec 0c             	sub    $0xc,%esp
8010717b:	68 41 81 10 80       	push   $0x80108141
80107180:	e8 fb 91 ff ff       	call   80100380 <panic>
...
801071e0:	68 5b 81 10 80       	push   $0x8010815b
...
80107268:	68 fc 81 10 80       	push   $0x801081fc
...
80107286:	83 ec 1c             	sub    $0x1c,%esp
  if (newsz >= KERNBASE)
80107289:	8b 45 10             	mov    0x10(%ebp),%eax
{
8010728c:	8b 7d 08             	mov    0x8(%ebp),%edi
  if (newsz >= KERNBASE)
8010728f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107292:	85 c0                	test   %eax,%eax
80107294:	0f 88 b6 00 00 00    	js     80107350 <allocuvm+0xd0>
  if (newsz < oldsz)
8010729a:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
8010729d:	8b 45 0c             	mov    0xc(%ebp),%eax
  if (newsz < oldsz)
801072a0:	0f 82 9a 00 00 00    	jb     80107340 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
801072a6:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
801072ac:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for (; a < newsz; a += PGSIZE)
801072b2:	39 75 10             	cmp    %esi,0x10(%ebp)
801072b5:	77 44                	ja     801072fb <allocuvm+0x7b>
801072b7:	e9 87 00 00 00       	jmp    80107343 <allocuvm+0xc3>
...
801072cb:	e8 50 d6 ff ff       	call   80104920 <memset>
...
801072e4:	e8 a7 fa ff ff       	call   80106d90 <mappages>
...
801072f9:	76 48                	jbe    80107343 <allocuvm+0xc3>
    mem = kalloc();
801072fb:	e8 80 b3 ff ff       	call   80102680 <kalloc>
...
80107309:	68 79 81 10 80       	push   $0x80108179
8010730e:	e8 8d 93 ff ff       	call   801006a0 <cprintf>
  if (newsz >= oldsz)
...
80107325:	e8 b6 f9 ff ff       	call   80106ce0 <deallocuvm.part.0>
      return 0;
...
8010736b:	68 91 81 10 80       	push   $0x80108191
80107370:	e8 2b 93 ff ff       	call   801006a0 <cprintf>
  if (newsz >= oldsz)
...
80107387:	e8 54 f9 ff ff       	call   80106ce0 <deallocuvm.part.0>
      kfree(mem);
8010738c:	83 ec 0c             	sub    $0xc,%esp
8010738f:	53                   	push   %ebx
80107390:	e8 2b b1 ff ff       	call   801024c0 <kfree>
      return 0;
...
801073c0:	5d                   	pop    %ebp
801073c1:	e9 1a f9 ff ff       	jmp    80106ce0 <deallocuvm.part.0>
...
801073fb:	e8 e0 f8 ff ff       	call   80106ce0 <deallocuvm.part.0>
...
8010744c:	68 ad 81 10 80       	push   $0x801081ad
...
80107480:	e8 9b d4 ff ff       	call   80104920 <memset>
...
80107494:	8b 13                	mov    (%ebx),%edx
80107496:	50                   	push   %eax
80107497:	29 c1                	sub    %eax,%ecx
80107499:	89 f0                	mov    %esi,%eax
8010749b:	e8 f0 f8 ff ff       	call   80106d90 <mappages>
...
801074eb:	a3 c4 54 11 80       	mov    %eax,0x801154c4
  lcr3(V2P(kpgdir)); // switch to the kernel page table
...
8010751c:	68 be 81 10 80       	push   $0x801081be
...
80107563:	0f 84 bd 00 00 00    	je     80107626 <copyuvm+0xd6>
    return 0;
  for (i = 0; i < sz; i += PGSIZE)
...
80107592:	68 c8 81 10 80       	push   $0x801081c8
...
801075f0:	e8 cb d3 ff ff       	call   801049c0 <memmove>
...
8010760b:	e8 80 f7 ff ff       	call   80106d90 <mappages>
...
8010761d:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107620:	0f 87 5a ff ff ff    	ja     80107580 <copyuvm+0x30>
  return d;
...
80107667:	68 e2 81 10 80       	push   $0x801081e2
...
80107720:	e8 9b d2 ff ff       	call   801049c0 <memmove>
    len -= n;
    buf += n;
