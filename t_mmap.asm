...
int main(int argc, char *argv[])
{
  ...
  17:	50                   	push   %eax
  18:	e8 6e 03 00 00       	call   38b <getvasize>
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 1a 08 00 00       	mov    $0x81a,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 28 0b 00 00       	mov    0xb28,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 28 0b 00 00    	mov    %edx,0xb28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 28 0b 00 00    	mov    0xb28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 28 0b 00 00    	mov    0xb28,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 28 0b 00 00    	mov    0xb28,%edx
 ...
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 2c 0b 00 00       	mov    $0xb2c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 30 0b 00 00 00 	movl   $0x0,0xb30
 792:	00 00 00 
    if(p->s.size >= nunits){
